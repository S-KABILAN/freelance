                    ...
                    <ul className="mx-auto mt-8 grid max-w-6xl grid-cols-1 gap-x-10 gap-y-12 sm:mt-12 sm:grid-cols-2 lg:mt-16 xl:grid-cols-3">
                        <li className="group relative transition-all duration-200 hover:-translate-y-1">
                            ...
                            <div className="mt-4 flex items-start justify-between space-x-6">
                                ...
                                <p className="text-lg font-bold text-gray-900">Project 1</p>
                                <p className="mt-0.5 text-sm font-normal text-gray-600">Developer </p>
                        ...
                        <li className="group relative transition-all duration-200 hover:-translate-y-1">
                            ...
                            <div className="mt-4 flex items-start justify-between space-x-6">
                                <div className="flex-1">
                                <p className="text-lg font-bold text-gray-900">Project 2</p>
                                <p className="mt-0.5 text-sm font-normal text-gray-600">Developer </p>
                        ...
                        <li className="group relative transition-all duration-200 hover:-translate-y-1">
                            ...
                            <div className="mt-4 flex items-start justify-between space-x-6">
                                <div className="flex-1">
                                <p className="text-lg font-bold text-gray-900">Project 3</p>
                                <p className="mt-0.5 text-sm font-normal text-gray-600">Developer </p>
                        ...
                        <li className="group relative transition-all duration-200 hover:-translate-y-1">
                            ...
                            <div className="mt-4 flex items-start justify-between space-x-6">
                                <div className="flex-1">
                                <p className ="text-lg font-bold text-gray-900">Project 4</p>
                                <p className="mt-0.5 text-sm font-normal text-gray-600">Developer </p>
                        ...
                        <li className="group relative transition-all duration-200 hover:-translate-y-1">
                            ...
                            <div className="mt-4 flex items-start justify-between space-x-6">
                                <div className="flex-1">
                                <p className="text-lg font-bold text-gray-900">Project 5</p>
                                <p className="mt-0.5 text-sm font-normal text-gray-600">Developer </p>
                        ...
                        <li className="group relative transition-all duration-200 hover:-translate-y-1">
                            ...
                            <div className="mt-4 flex items-start justify-between space-x-6">
                                <div className="flex-1">
                                <p className="text-lg font-bold text-gray-900">Project 6</p>
                                <p className="mt-0.5 text-sm font-normal text-gray-600">Developer </p>
